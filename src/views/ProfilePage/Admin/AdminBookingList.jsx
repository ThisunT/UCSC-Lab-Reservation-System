...
function createData(array) {
    ...
    for (i=0;i<array.length;i++){
        data.push(getRow(array[i].lab,array[i].eventname, (new Date(array[i].starttime)).toLocaleDateString(), (new Date(array[i].starttime)).toLocaleTimeString().replace(":00","") + "-" + (new Date(array[i].endtime)).toLocaleTimeString().replace(":00",""), array[i].bookedby, array[i]._id));
    }
    counter = -1;
    return data;
}
...
const columnData = [
    ...
    { id: 'subject', numeric: true, disablePadding: false, label: 'Subject / Event' },
    { id: 'date', numeric: true, disablePadding: false, label: 'Date' },
    { id: 'time', numeric: true, disablePadding: false, label: 'Time' },
    { id: 'user', numeric: true, disablePadding: false, label: 'Booked By' }
];
...
class EnhancedTable extends React.Component {
    ...
    componentWillReceiveProps(nextProps){
        if(nextProps.events !== this.props.events){
            ...
            this.setState({data1: createData(nextProps.events)}, () =>{
                this.setState({data:createData(nextProps.events).sort((a, b) => (a.lab < b.lab ? -1 : 1))});
            });
